...
print('Ready for contact forces')
...
import steadyturning_funcs as stFunc

#configuration
q_dict, q_dict_d = stFunc.configuration(lean, steer)
print q_dict, 
print q_dict_d, '\n'

#dynamic equations
dynamic_equ = stFunc.forcing_dynamic_equations(F_full, para_dict, q_dict, u_dict)
print dynamic_equ, '\n'

#nonholonomic equations
inde_expression, inde_expression_list = stFunc.de_by_inde(nonholonomic, 
                                                q_dict, para_dict, u_dict)
print inde_expression
print inde_expression_list, '\n'

#substitution
dynamic_nonho_equ = stFunc.dynamic_nonholonomic_equations(inde_expression_list, dynamic_equ)
print dynamic_nonho_equ, '\n'

#=====================================
print ('Calculations for equilibrium')
...
contact_forces = [value.subs(ud_dict).subs(u_dict).subs(para_dict).subs(q_dict).subs(u_others_dict) 
                  for value in con_forces_noncontri]

sym.solve(contact_forces,[Fx_r, Fy_r, Fx_f, Fy_f])
